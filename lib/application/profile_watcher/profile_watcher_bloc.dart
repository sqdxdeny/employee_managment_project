...
class ProfileWatcherBloc
  ...
  Future<void> _updateProfile(_UpdateProfile event, Emitter<ProfileWatcherState> emit) async {
    emit(state.copyWith(
      profile: event.profile,
    ));
  }

  Future<void> _authorize(_Authorize event, Emitter<ProfileWatcherState> emit) async {
    emit(state.copyWith(
  ...
  Future<void> _signOut(_SignOut event, Emitter<ProfileWatcherState> emit) async {
    emit(state.copyWith(
